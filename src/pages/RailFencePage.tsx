      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12">
        <div className="max-w-5xl mx-auto space-y-8">
          <header className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">Rail Fence Cipher</h2>
            <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
              A transposition cipher that writes the plaintext in a zigzag pattern on a given number of rails, then reads it row by row.
            </p>
          </header>
              ...
              <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-3xl p-8 shadow-2xl h-full flex flex-col">
                ...
                <div className="mt-8 pt-8 border-t border-white/10 grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/5 rounded-2xl p-4">
                    ...
                    <div className="text-xl font-bold text-white truncate">Rail Fence</div>
                  </div>
                </div>
              </div>
            </div>
