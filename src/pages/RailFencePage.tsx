...
import { railFenceEncrypt, railFenceDecrypt } from '@/algorithms/reinfenceEncrypt';
...
const RailFencePage: React.FC = () => {
  ...
  useEffect(() => {
    const result = isEncrypt ? railFenceEncrypt(inputText, rails) : railFenceDecrypt(inputText, rails);
    setOutputText(result);
  }, [inputText, rails, isEncrypt]);
      ...
      <main className="flex-1 overflow-y-auto p-3 md:p-4 lg:p-6">
        <div className="max-w-5xl mx-auto space-y-4">
          <header className="space-y-2">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight">Rail Fence Cipher</h2>
            <p className="text-sm text-slate-400 max-w-2xl leading-snug">
              A transposition cipher for zigzag patterns across multiple rails.
            </p>
          </header>
                ...
                <div className="space-y-4">
                  ...
                  <div className="col-span-2">
                    <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1 flex justify-between">
                      ...
                      <span className="text-blue-400 font-bold">{rails}</span>
                    </label>
                    <input 
              ...
              <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-2xl p-4 shadow-lg h-full flex flex-col">
                ...
                <div className="mt-4 pt-4 border-t border-white/10 grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <div className="text-lg font-bold text-white truncate">Rail Fence</div>
                  </div>
                </div>
              </div>
            </div>
