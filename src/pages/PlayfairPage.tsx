      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12">
        <div className="max-w-5xl mx-auto space-y-8">
          <header className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">Playfair Cipher</h2>
            <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
              A digraph substitution cipher that encrypts pairs of letters using a 5x5 grid based on a keyword.
            </p>
          </header>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Plaintext / Ciphertext</label>
                    <textarea 
                      value={inputText}
                      ...
                      {matrix.map((row, rowIndex) => (
                        row.map((cell, colIndex) => (
                          <div
                            ...
                            className="w-10 h-10 flex items-center justify-center bg-slate-900 border border-slate-800 rounded text-sm font-bold shadow-inner"
                          >
                            {cell}
                          </div>
                        ))
              ...
              <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-3xl p-8 shadow-2xl h-full flex flex-col">
                ...
                <div className="mt-8 pt-8 border-t border-white/10 grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-2xl p-4">
                    <div className="text-[10px] text-blue-300 uppercase font-bold tracking-tighter mb-1">Length</div>
                    <div className="text-xl font-bold text-white">{outputText.length} <span className="text-[10px] font-normal text-slate-400 ml-1">CHARS</span></div>
                  </div>
                  <div className="bg-white/5 rounded-2xl p-4">
                    <div className="text-[10px] text-blue-300 uppercase font-bold tracking-tighter mb-1">Method</div>
                    <div className="text-xl font-bold text-white truncate">Playfair</div>
                  </div>
                </div>
              </div>
            </div>
