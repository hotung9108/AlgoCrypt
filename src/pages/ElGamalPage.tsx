          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            <div className="lg:col-span-7 space-y-5">
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-5 backdrop-blur-sm">
                <h3 className="font-bold text-lg text-slate-100 flex items-center gap-2 mb-5">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Prime Number (q)</label>
                      <input
                        type="number"
                        value={q}
                        onChange={(e) => setQ(Math.max(2, parseInt(e.target.value) || 0))}
                        className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                        placeholder="e.g., 23"
                      />
                      {qError && (
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Primitive Root (a)</label>
                      <input
                        type="number"
                        value={a}
                  ...
                  <div className="border-t border-slate-700 pt-4 mt-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Private Key (xA)</label>
                        <input
                          type="number"
                          value={xA}
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Random Number (k)</label>
                        <input
                          type="number"
                          value={k}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Message (M)</label>
                    <input
                      type="number"
                      value={message}
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-5 shadow-xl overflow-hidden min-h-[400px]">
                <h3 className="font-bold text-lg text-slate-100 mb-5 flex items-center gap-2">
                  <svg className="w-5 h-5 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  Algorithm Details
                </h3>
                <div className="flex items-center justify-center bg-slate-950/30 rounded-lg border border-slate-800/50 p-5 min-h-[300px]">
                  <div className="w-full space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Public Key</div>
                        <div className="text-2xl font-bold text-blue-300">{yA}</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Ciphertext 1 (C1)</div>
                        <div className="text-2xl font-bold text-blue-300">{C1}</div>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Ciphertext 2 (C2)</div>
                        <div className="text-2xl font-bold text-indigo-300">{C2}</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Decryption Key</div>
                        <div className="text-2xl font-bold text-indigo-300">{K_dec}</div>
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20 border border-blue-500/20 rounded-lg p-3 mt-3">
            ...
            <div className="lg:col-span-5 space-y-5">
              <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-xl p-5 h-full flex flex-col">
                ...
                <div className="flex-1 bg-slate-950/80 border border-white/5 rounded-lg p-5 overflow-y-auto scrollbar-hide mb-5">
                  ...
                  <div className="mt-5 pt-5 border-t border-white/10 space-y-2 text-xs text-slate-400 mono">
