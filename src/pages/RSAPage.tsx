        ...
        <div className="max-w-5xl mx-auto space-y-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            <div className="lg:col-span-7 space-y-5">
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-5 backdrop-blur-sm">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Prime Number (p)</label>
                      <input
                        type="number"
                        value={p}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Public Exponent (e)</label>
                      <input
                        type="number"
                        value={e}
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1 text-xs">Message to Encrypt (M)</label>
                      <input
                        type="number"
                        value={message}
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-5 overflow-hidden min-h-[400px]">
                  ...
                  <div className="w-full space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Modulus (n)</div>
                        <div className="text-2xl font-bold text-blue-300">{n}</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Phi φ(n)</div>
                        <div className="text-2xl font-bold text-blue-300">{phi}</div>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Private Key (d)</div>
                        <div className="text-2xl font-bold text-indigo-300">{d}</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                        <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Encryption (c)</div>
