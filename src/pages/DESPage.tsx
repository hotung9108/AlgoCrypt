...
import { desEncryptHex, desDecryptHex } from '@/algorithms/desEncrypt';
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea 
                      ...
                      placeholder="Enter hex text (16 characters, 64 bits)..."
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input 
                      ...
                      placeholder="Enter 16-character hex key (64 bits)..."
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-3xl p-8 shadow-2xl h-full flex flex-col">
                ...
                <div className="mt-8 pt-8 border-t border-white/10 grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/5 rounded-2xl p-4">
                    ...
                    <div className="text-xl font-bold text-white truncate">DES</div>
                  </div>
                </div>
              </div>
            </div>
