                ...
                <div className="max-w-5xl mx-auto space-y-4">
                    <header className="space-y-2">
                        ...
                        <p className="text-sm text-slate-400 max-w-2xl leading-snug">
                            Uses the plaintext as part of the key for enhanced security.
                        </p>
                    </header>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-28 bg-slate-950 border border-slate-800 rounded-lg p-3 text-sm text-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all mono resize-none"
                        ...
                        <div className="lg:col-span-5 space-y-4">
                            <div className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 border border-purple-500/20 rounded-2xl p-4 shadow-lg h-full flex flex-col">
                                <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex-1 bg-slate-950/80 border border-white/5 rounded-lg p-4 overflow-y-auto scrollbar-hide">
                                    <div className="text-xl font-black tracking-widest break-all leading-relaxed bg-gradient-to-br from-purple-100 to-pink-100 bg-clip-text text-transparent mono">
                                ...
                                <div className="mt-4 pt-4 border-t border-white/10 grid grid-cols-2 gap-2">
                                    <div className="bg-white/5 rounded-lg p-3">
                                        <div className="text-[9px] text-purple-300 uppercase font-bold tracking-tighter mb-0.5">
                                            Length
                                        </div>
